...
```html
<div class="alert {MODIFIER}" role="alert">{CONTENT}</div>
```
...
```html
<input class="input pika-single" type="text" />
```
...
```html
<input class="checkbox {MODIFIER}" type="checkbox" />
```
...
```html
<div class="{MODIFIER} collapse" tabindex="0">
  <div class="collapse-title">{title}</div>
  <div class="collapse-content">{CONTENT}</div>
</div>
```
...
```html
<label class="btn drawer-button" for="my-drawer">Open/close drawer</label>
```
...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-content flex flex-col items-center justify-center">
    <!-- Page content here -->
    <label class="btn drawer-button lg:hidden" for="my-drawer-3"> Open drawer </label>
  </div>
  <div class="drawer-side">
    <label class="drawer-overlay" for="my-drawer-3" aria-label="close sidebar"></label>
...
<ul class="dropdown-content" id="{id}" popover style="position-anchor:--{anchor}">
  {CONTENT}
</ul>
```
...
<div class="dropdown">
  ...
  <ul class="dropdown-content" tabindex="-1">
    {CONTENT}
  </ul>
</div>
```
...
```html
<div class="fab">
  <div class="btn btn-lg btn-circle btn-primary" tabindex="0" role="button">{IconOriginal}</div>
...
```html
<input class="file-input {MODIFIER}" type="file" />
```
...
```html
<input class="input {MODIFIER}" type="{type}" placeholder="Type here" />
```
...
```html
<label class="btn" for="my-modal">Open modal</label>
...
```html
<a class="btn" href="#my-modal">Open modal</a>
...
```html
<input class="radio {MODIFIER}" type="radio" name="{name}" />
```
...
```html
<input class="range {MODIFIER}" type="range" min="0" max="100" value="40" />
```
...
```html
<div class="tabs {MODIFIER}" role="tablist">
  <button class="tab" role="tab">Tab</button>
</div>
```
...
<div class="tabs tabs-box" role="tablist">
  <input class="tab" type="radio" name="my_tabs" aria-label="Tab" />
</div>
```
...
```html
<input class="theme-controller" type="checkbox" value="{theme-name}" />
```
...
```html
<input class="toggle {MODIFIER}" type="checkbox" />
```
...
```html
<input class="input validator" type="{type}" required />
